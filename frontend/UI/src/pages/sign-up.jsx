...
export function SignUp() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!firstName || !lastName) {
      setLocalError('Please enter first and last name');
      return;
    }
      ...
      <div className="w-full max-w-md relative z-10">
        <div className={`backdrop-blur-xl rounded-3xl shadow-2xl shadow-purple-500/30 p-10 ${getCardClasses(isDark)}`}>
          ...
          <div className="text-center mb-10">
            ...
            <p className={`text-base ${getTextClasses(isDark, 'secondary')}`}>Create your account to get started</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className={`px-4 ${isDark ? 'bg-gray-900' : 'bg-gray-100'} ${getTextClasses(isDark, 'muted')}`}>Or register with</span>
              </div>
            </div>
            ...
            <p className={`text-center font-medium mt-8 ${getTextClasses(isDark, 'secondary')}`}>
              ...
              <a href="/sign-in" className={`font-semibold underline decoration-purple-400/50 ${
                isDark 
                  ? 'text-purple-400 hover:text-purple-300'
                  : 'text-purple-600 hover:text-purple-500'
              }`}>
